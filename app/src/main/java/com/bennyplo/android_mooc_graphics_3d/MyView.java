...
public class MyView extends View {
    ...
    public MyView(Context context) {
        ...
        draw_cube_vertices=scale(draw_cube_vertices,50,50,50);
        draw_cube_vertices=share(draw_cube_vertices,2,1);
    ...
    private Coordinate[]rotate(Coordinate []vertices,double hx,double hy)
    {
        double []matrix=GetIdentityMatrix();
        matrix[2]=hx;
        matrix[6]=hy;
